...
type:string="offline";
  ...
  constructor(private _addcart:AddtocartService,private _cart:CartService,private _offer:OfferService,private _category:CategoryService,private _product:ProductserviceService,private _route:Router) { }
